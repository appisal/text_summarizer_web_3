...
st.markdown("""
    <style>
        ...
        /* Neon Glow Effect */
        .neon-glow {
            text-shadow: 0 0 5px #ff4b4b, 0 0 10px #ff7f50, 0 0 15px #ff4b2b;
        }
    ...
    <div class="title-container neon-glow"> AI-Powered Text Summarizer</div>
